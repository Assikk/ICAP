    ...
    >
      <div class="mt-3 text-center">
        <div class="flex justify-between pb-8">
          ...
          <div class="cursor-pointer" @click="showAddUser(false)">
      ...
      >
        ...
        <div class="flex gap-4">
          <Button white medium @click="showAddUser(false)"> Отмена </Button>
          <Button medium @click="addUser"> Добавить </Button>
        </div>
      </div>
    </div>
  </div>
  ...
  methods: {
    ...
    async addUser() {
      try {
        ...
        this.successAlert('Регион успешно добавлен')
        ...
        if (err.response?.data) {
          ...
          errors.push('Ошибка при добавлении региона')
        }
