        ...
        <div class="flex justify-between pb-8">
          <div>
            <h3
              ...
              id="modal-title"
            >
              Редактировать гендер
            </h3>
          </div>
          <svg width="20" height="20" fill="#B3B9C9" class="cursor-pointer" @click="show_editGender(false)">
        ...
        <div class="grid gap-8 mb-8">
          <div class="flex justify-between gap-x-4">
            <Input
              ...
              placeholder="Введите название гендера"
  ...
  methods: {
    ...
    async editGender() {
      ...
      try {
        ...
        this.success_alert('Гендер успешно изменён')
        ...
        if (err.response?.data) {
          ...
          errors.push('Ошибка редактировании гендера')
        }
