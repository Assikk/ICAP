        ...
        <div class="flex justify-between pb-8">
          <div>
            <h3
              ...
              id="modal-title"
            >
              Редактировать Участник согласен на смс-оповещение или обзвон
            </h3>
          </div>
  ...
  methods: {
    ...
    async editGender() {
      ...
      try {
        ...
        this.success_alert(
          'Участник согласен на смс-оповещение или обзвон успешно изменён'
        )
        ...
        if (err.response?.data) {
          ...
          errors.push(
            'Ошибка редактировании Участник согласен на смс-оповещение или обзвон'
          )
        }
