      ...
      <div class="mt-3">
        <div class="flex justify-between pb-8">
          <div>
            <h3
              ...
              id="modal-title"
            >
              Добавить Участник согласен на смс-оповещение или обзвон
            </h3>
          </div>
        ...
        <div class="grid gap-8 mb-8">
          <div class="flex justify-between gap-x-4">
            <Input
              label="Участник согласен на смс-оповещение или обзвон (RU)*"
              id="name_ru"
              v-model="name_ru"
              placeholder="Введите название Участник согласен на смс-оповещение или обзвон"
            ...
            <Input
              label="Участник согласен на смс-оповещение или обзвон (KZ)*"
              id="name_kk"
              v-model="name_kk"
              placeholder="Введите название Участник согласен на смс-оповещение или обзвон"
  ...
  methods: {
    ...
    async addGender() {
      ...
      try {
        ...
        this.success_alert(
          'Участник согласен на смс-оповещение или обзвон успешно добавлен'
        )
        ...
        if (err.response?.data) {
          ...
          errors.push(
            'Ошибка при добавлении Участник согласен на смс-оповещение или обзвон'
          )
        }
