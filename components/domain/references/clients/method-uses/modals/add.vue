<template>
  ...
  >
    <div
      ...
      @click="show_addMethoduses(false)"
    />
    <div
    ...
    >
      <div class="mt-3">
        <div class="flex justify-between pb-8">
          ...
          <div class="cursor-pointer" @click="show_addMethoduses(false)">
      ...
      <div class="flex gap-4 justify-end py-3 border-t border-t-[#E5E7EB]">
        <Button white medium @click="show_addMethoduses(false)">
          Отмена
        </Button>
        <Button medium @click="addMethoduses"> Добавить </Button>
      </div>
    </div>
  </div>
</template>
    ...
    async addMethoduses() {
      ...
      try {
        ...
        if (err.response?.data) {
          ...
          errors.push(
            'Ошибка при добавлении Преимущественный способ употребления'
          )
        }
