        ...
        <div class="flex justify-between pb-8">
          <div>
            <h3
              ...
              id="modal-title"
            >
              Редактировать Количество выданных купонов
            </h3>
          </div>
  ...
  methods: {
    ...
    async editGender() {
      ...
      try {
        ...
        this.success_alert('Количество выданных купонов успешно изменён')
        ...
        if (err.response?.data) {
          ...
          errors.push('Ошибка редактировании Количество выданных купонов')
        }
