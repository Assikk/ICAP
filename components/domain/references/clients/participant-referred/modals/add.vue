      ...
      <div class="mt-3">
        <div class="flex justify-between pb-8">
          <div>
            <h3
              ...
              id="modal-title"
            >
              Добавить Количество выданных купонов
            </h3>
          </div>
        ...
        <div class="grid gap-8 mb-8">
          <div class="flex justify-between gap-x-4">
            <Input
              label="Количество выданных купонов (RU)*"
              id="name_ru"
              v-model="name_ru"
              placeholder="Введите название Количество выданных купонов"
            ...
            <Input
              label="Количество выданных купонов (KZ)*"
              id="name_kk"
              v-model="name_kk"
  ...
  methods: {
    ...
    async addGender() {
      ...
      try {
        ...
        this.success_alert('Количество выданных купонов успешно добавлен')
        ...
        if (err.response?.data) {
          ...
          errors.push('Ошибка при добавлении Количество выданных купонова')
        }
