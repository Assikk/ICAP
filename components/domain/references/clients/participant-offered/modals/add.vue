        ...
        <div class="flex justify-between pb-8">
          <div>
            <h3
              ...
              id="modal-title"
            >
              Добавить Участнику предложена ДКП
            </h3>
          </div>
  ...
  methods: {
    ...
    async addGender() {
      ...
      try {
        ...
        this.success_alert('Участнику предложена ДКП успешно добавлен')
        ...
        if (err.response?.data) {
          ...
          errors.push('Ошибка при добавлении Участнику предложена ДКП')
        }
