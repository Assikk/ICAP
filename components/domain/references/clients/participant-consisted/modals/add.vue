      ...
      <div class="mt-3">
        <div class="flex justify-between pb-8">
          <div>
            <h3
              ...
              id="modal-title"
            >
              Добавить Когда участник состоял на ОЗТ
            </h3>
          </div>
        ...
        <div class="grid gap-8 mb-8">
          <div class="flex justify-between gap-x-4">
            <Input
              label="Когда участник состоял на ОЗТ (RU)*"
              id="name_ru"
              v-model="name_ru"
              placeholder="Введите название Когда участник состоял на ОЗТ"
            ...
            <Input
              label="Когда участник состоял на ОЗТ (KZ)*"
              id="name_kk"
              v-model="name_kk"
              placeholder="Введите название Когда участник состоял на ОЗТ"
