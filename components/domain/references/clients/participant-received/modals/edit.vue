        ...
        <div class="flex justify-between pb-8">
          <div>
            <h3
              ...
              id="modal-title"
            >
              Редактировать Участнику провели консультацию после обследования
            </h3>
          </div>
        ...
        <div class="grid gap-8 mb-8">
          <div class="flex justify-between gap-x-4">
            <Input
              ...
              placeholder="Введите название Участнику провели консультацию после обследованияа"
  ...
  methods: {
    ...
    async editGender() {
      ...
      try {
        ...
        this.success_alert(
          'Участнику провели консультацию после обследования успешно изменён'
        )
        ...
        if (err.response?.data) {
          ...
          errors.push(
            'Ошибка редактировании Участнику провели консультацию после обследованияа'
          )
        }
