      ...
      <div class="mt-3">
        <div class="flex justify-between pb-8">
          <div>
            <h3
              ...
              id="modal-title"
            >
              Добавить Участнику провели консультацию после обследования
            </h3>
          </div>
          <div class="cursor-pointer" @click="show_addGender(false)">
        ...
        <div class="grid gap-8 mb-8">
          <div class="flex justify-between gap-x-4">
            <Input
              label="Участнику провели консультацию после обследования (RU)*"
              id="name_ru"
              v-model="name_ru"
              placeholder="Введите название Участнику провели консультацию после обследования"
            ...
            <Input
              label="Участнику провели консультацию после обследования (KZ)*"
              id="name_kk"
              v-model="name_kk"
  ...
  methods: {
    ...
    async addGender() {
      ...
      try {
        ...
        this.success_alert(
          'Участнику провели консультацию после обследования успешно добавлен'
        )
        ...
        if (err.response?.data) {
          ...
          errors.push(
            'Ошибка при добавлении Участнику провели консультацию после обследованияа'
          )
        }
