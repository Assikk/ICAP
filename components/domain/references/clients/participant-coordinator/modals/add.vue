        ...
        <div class="flex justify-between pb-8">
          <div>
            <h3
              ...
              id="modal-title"
            >
              Добавить Участника сопроводили к координатору по ДКП
            </h3>
          </div>
  ...
  methods: {
    ...
    async addGender() {
      ...
      try {
        ...
        this.success_alert(
          'Участника сопроводили к координатору по ДКП успешно добавлен'
        )
        ...
        if (err.response?.data) {
          ...
          errors.push(
            'Ошибка при добавлении Участника сопроводили к координатору по ДКП'
          )
        }
