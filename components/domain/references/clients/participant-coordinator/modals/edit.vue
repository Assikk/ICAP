      ...
      <div class="mt-3">
        <div class="flex justify-between pb-8">
          <div>
            <h3
              ...
              id="modal-title"
            >
              Редактировать Участника сопроводили к координатору по ДКП
            </h3>
          </div>
        ...
        <div class="grid gap-8 mb-8">
          <div class="flex justify-between gap-x-4">
            <Input
              label="Участника сопроводили к координатору по ДКП (RU)*"
              id="name_ru"
              v-model="form.name_ru"
              placeholder="Введите название Участника сопроводили к координатору по ДКП"
            ...
            <Input
              label="Участника сопроводили к координатору по ДКП (KZ)*"
              id="name_kk"
  ...
  methods: {
    ...
    async editGender() {
      ...
      try {
        ...
        this.success_alert(
          'Участника сопроводили к координатору по ДКП успешно изменён'
        )
        ...
        if (err.response?.data) {
          ...
          errors.push(
            'Ошибка редактировании Участника сопроводили к координатору по ДКП'
          )
        }
