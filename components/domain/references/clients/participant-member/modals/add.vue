      ...
      <div class="mt-3">
        <div class="flex justify-between pb-8">
          <div>
            <h3
              ...
              id="modal-title"
            >
              Добавить Состоял ли участник в ОЗТ
            </h3>
          </div>
        ...
        <div class="grid gap-8 mb-8">
          <div class="flex justify-between gap-x-4">
            <Input
              label="Состоял ли участник в ОЗТ (RU)*"
              id="name_ru"
              v-model="name_ru"
              placeholder="Введите название Состоял ли участник в ОЗТ"
            ...
            <Input
              label="Состоял ли участник в ОЗТ (KZ)*"
              id="name_kk"
              v-model="name_kk"
              placeholder="Введите название Состоял ли участник в ОЗТ"
  ...
  methods: {
    ...
    async addGender() {
      ...
      try {
        ...
        this.success_alert('Состоял ли участник в ОЗТ успешно добавлен')
        ...
        if (err.response?.data) {
          ...
          errors.push('Ошибка при добавлении Состоял ли участник в ОЗТ')
        }
