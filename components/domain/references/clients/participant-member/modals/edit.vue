        ...
        <div class="flex justify-between pb-8">
          <div>
            <h3
              ...
              id="modal-title"
            >
              Редактировать Состоял ли участник в ОЗТ
            </h3>
          </div>
  ...
  methods: {
    ...
    async editGender() {
      ...
      try {
        ...
        this.success_alert('Состоял ли участник в ОЗТ успешно изменён')
        ...
        if (err.response?.data) {
          ...
          errors.push('Ошибка редактировании Состоял ли участник в ОЗТ')
        }
